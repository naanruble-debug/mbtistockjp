  ...
  if (typeof source === 'number') {
    ...
    if (resolved?.uri) {
      if (resolved.uri.endsWith('.lottie')) {
        return {
          sourceDotLottieURI: resolved.uri
        };
      }
      return {
 ...
 */
export const LottieView = /*#__PURE__*/forwardRef((props, ref) => {
  const {
    source,
    style,
    progress,
  ...
  const handleAnimationFailure = useCallback(event => {
...
//# sourceMappingURL=GraniteLottieView.js.map